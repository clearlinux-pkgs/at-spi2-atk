...
Source0  : https://download.gnome.org/sources/at-spi2-atk/2.34/at-spi2-atk-2.34.2.tar.xz
...
%prep
%setup -q -n at-spi2-atk-2.34.2
cd %{_builddir}/at-spi2-atk-2.34.2
pushd ..
cp -a at-spi2-atk-2.34.2 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1586221873
