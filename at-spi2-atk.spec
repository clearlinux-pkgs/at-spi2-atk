...
Source0  : https://download.gnome.org/sources/at-spi2-atk/2.26/at-spi2-atk-2.26.0.tar.xz
...
%prep
%setup -q -n at-spi2-atk-2.26.0
pushd ..
cp -a at-spi2-atk-2.26.0 build32
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1505317856
