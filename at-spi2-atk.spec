...
Source0  : https://download.gnome.org/sources/at-spi2-atk/2.34/at-spi2-atk-2.34.1.tar.xz
...
%prep
%setup -q -n at-spi2-atk-2.34.1
pushd ..
cp -a at-spi2-atk-2.34.1 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1570478452
